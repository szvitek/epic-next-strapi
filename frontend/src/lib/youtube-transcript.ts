/*
the https://www.npmjs.com/package/youtube-transcript package is currently broken,
snippet is based on the comments: https://github.com/Kakulukian/youtube-transcript/issues/19#issuecomment-2041204365
*/
